...
public class Parse4JTestCase {
	...
	public static String CLASS_NAME = "parseplatform";
	...
	protected ParseUser getParseUser(String number) {
		...
		parseUser.setUsername("parseplatform-user" + number);
		parseUser.setPassword("parseplatform-password");
		parseUser.setEmail("parseplatform-email"+number+"@gmail.com");
